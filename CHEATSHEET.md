...
- **Searchable & Sortable Budget Tables** — Adds DataTables search, column sort, paging, and checkbox filter panes (auto on categorical columns) to the Legacy Office budget tables on the Agent Dashboard.
